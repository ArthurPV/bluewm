...
#define BLUE_WM_SHORTCUT_MOVE_WORKSPACE(n) \
	BLUE_WM_SHORTCUT(BLUE_WM_MOVE_WINDOW_MASK | ShiftMask, XK_##n, &move_workspace_##n##__BlueWM)

	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(1),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(2),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(3),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(4),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(5),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(6),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(7),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(8),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(9),
	BLUE_WM_SHORTCUT_MOVE_WORKSPACE(0),

#undef BLUE_WM_SHORTCUT_MOVE_WORKSPACE
};
